...
//Button
const upButton = document.querySelector('.upA');
const downButton = document.querySelector('.downA');
const leftButton = document.querySelector('.leftA');
const rightButton = document.querySelector('.rightA');
upButton.addEventListener('click', moveUpElement);
downButton.addEventListener('click', moveDownElement);
...
function setRandomCell(numberElement) {
    ...
    for (let i = 0; i < numberElement; i++) {
        ...
        if (Math.random() < luckFor2) {
            cell.setValue(2);
        } else if (Math.random() < luckFor2 + luckFor4) {
            cell.setValue(4);
        } else {
            cell.setValue(8);
        }
